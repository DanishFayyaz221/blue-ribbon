...
const PLACEHOLDER_IMAGE = "/our-team/our-team.png";

function toAgentCard(s: Staff): AgentCardData {
  return {
    name: s.name,
    role: s.role || "Sales Agent",
...
export default async function AgentsPage() {
  ...
  const agents = items.map(toAgentCard);
      ...
      <main>
        ...
        <div className="hidden sm:block">
          ...
          <section className="container-page mt-[clamp(38px,3.15vw,64px)]">
            ...
            {agents.length === 0 ? (
              <p className="mt-6 font-display text-brand-bunker/70">
