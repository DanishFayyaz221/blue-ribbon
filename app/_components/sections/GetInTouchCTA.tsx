...
export function GetInTouchCTA({
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 lg:aspect-[1920/720]">
        <div className="flex items-center px-[clamp(22px,4.5vw,86px)] py-[clamp(28px,2.7vw,50px)] lg:py-0">
          <div className="w-full max-w-[520px]">
            <h2 className="font-display font-bold text-white text-[clamp(2rem,3vw,3.25rem)] leading-[1.1]">
              {title}
            </h2>
            <p className="mt-[clamp(44px,4vw,68px)] font-display font-normal text-white/90 text-[15px] sm:text-[17px] leading-[1.6] tracking-[0.01em]">
              {body}
            </p>
            <div className="mt-[clamp(48px,4.4vw,76px)] mb-[clamp(24px,2.8vw,44px)]">
              <Button
                href={buttonHref}
                variant="outline"
                size="md"
