  ...
  return (
    <section className="relative w-full overflow-hidden bg-brand-navy pt-[clamp(32px,3vw,60px)] pb-[clamp(64px,6vw,120px)]">
      ...
      <div className="relative z-10 container-page">
        <h2 className="mx-auto max-w-[960px] text-center font-display font-bold text-white text-[20px] sm:text-[clamp(1.5rem,2.4vw,2.6rem)] leading-[1.25] sm:whitespace-nowrap sm:-translate-x-[clamp(12px,2vw,40px)]">
        ...
        <div className="mt-[clamp(28px,3.15vw,64px)] grid grid-cols-1 sm:grid-cols-3 gap-[16px] sm:gap-[clamp(20px,2.25vw,50px)]">
          {values.map((v) => (
            <div
              key={v.title}
              className="rounded-[16px] bg-white/[0.06] p-[20px] sm:p-[clamp(20px,1.8vw,32px)]"
            >
