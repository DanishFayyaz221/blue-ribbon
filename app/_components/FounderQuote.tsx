 ...
 * the photo without a CSS gradient here.
 */
  ...
  return (
    <>
      ...
      {/* Full-bleed banner at its natural 1920x984 aspect, capped only on very
          wide screens. Its white top edge is part of the asset. */}
      <div className="relative mt-[clamp(12px,1.4vw,20px)] aspect-[1920/984] max-h-[984px] w-full">
        <Image
