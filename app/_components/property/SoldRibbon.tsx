/**
 * Diagonal navy "SOLD" band across a photo's corner.
 *
...
export function SoldRibbon({
  ...
  return (
    <span
      aria-label="Sold"
      className={`pointer-events-none absolute z-20 bg-brand-navy text-center font-display font-bold uppercase leading-none tracking-[0.12em] text-white shadow-[0_2px_6px_rgba(0,0,0,0.25)] ${CORNER[corner][size]} ${SIZE[size]}`}
    >
      Sold
    </span>
  );
