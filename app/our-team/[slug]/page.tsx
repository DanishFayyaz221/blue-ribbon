    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="container-page mt-[clamp(12px,1.5vw,24px)]">
          <div className="grid grid-cols-1 gap-[clamp(20px,2.4vw,44px)] sm:grid-cols-[minmax(0,300px)_1fr] sm:items-start">
            ...
            <div>
              <LineReveal
                as="h1"
                className="font-display font-bold text-brand-bunker text-[clamp(1.5rem,2.4vw,2.6rem)] leading-[1.1]"
              >
                {agent.name}
              </LineReveal>
              ...
              {profile.bio && (
                <p className="mt-[clamp(14px,1.2vw,22px)] max-w-[680px] font-display text-[clamp(13px,0.95vw,16px)] leading-[1.7] text-brand-bunker">
                  {profile.bio}
                </p>
              )}
        ...
        <section className="container-page mt-[clamp(36px,3.6vw,72px)]">
          <LineReveal
            as="h2"
            className="font-display font-bold text-brand-bunker text-[clamp(1.15rem,1.5vw,1.75rem)] leading-[1.15]"
          >
            {`${agent.name.split(/\s+/)[0]}’s Listings`}
          </LineReveal>
          ...
          {listings.length > 0 ? (
            ...
            <p className="mt-[clamp(16px,1.4vw,24px)] font-display text-[clamp(13px,0.95vw,16px)] text-brand-bunker">
